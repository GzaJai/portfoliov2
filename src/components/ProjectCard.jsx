...
const ProjectCard = ({ projectName, projectUrl, imageUrl, onClick }) => {
  return (
    <div onClick={onClick} className="w-[90%] mx-auto bg-linear-to-br from-indigo-500/20 via-purple-500/10 to-transparent backdrop-blur-md rounded-[39px] shadow-2xl p-8 cursor-pointer">
