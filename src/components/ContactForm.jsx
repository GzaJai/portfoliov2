...
const ContactForm = () => {
    ...
    return (
        <>
            ...
            <h3 className='w-[60%] mx-auto mb-7 font-bold text-3xl text-indigo-300 md:w-[50%]'>{t("contact.title")}</h3>
            <form onSubmit={handleSubmit} className="flex flex-col w-[90%] mx-auto bg-linear-to-br from-indigo-500/20 via-purple-500/10 to-transparent backdrop-blur-md rounded-[39px] shadow-2xl py-12 px-6 items-center">
                ...
                <div className="p-4 flex flex-col w-[90%] gap-3">
                    <label htmlFor="from_name" className='font-bold'>{t("contact.nameLabel")}</label>
                    <input type="text" name="from_name" id="from_name" className='h-8 rounded-md max-w-70 p-3 border border-indigo-100/40' placeholder={t("contact.namePlaceholder")}  />
                </div>
                <div className="p-4 flex flex-col w-[90%] gap-3">
                    <label htmlFor="reply_to" className='font-bold'>{t("contact.emailLabel")}</label>
                    <input type="text" name="reply_to" id="reply_to" className='h-8 rounded-md max-w-70 p-3 border border-indigo-100/40' placeholder={t("contact.emailPlaceholder")}  />
                </div>
                <div className="p-4 flex flex-col w-[90%] gap-3">
                    <label htmlFor="message" className='font-bold'>{t("contact.messageLabel")}</label>
